...
export default async function handler(req, res) {
  ...
  if (type === 'payment_intent.succeeded') {
    ...
    if (email) {
      ...
      await upsertMember(airtableToken, BASE_ID, TABLE_ID, {
        email, name: (pi.metadata && pi.metadata.name) || '', plan, status: 'active',
